...
final class ComplexMatrixAlgebraTests: XCTestCase {
    ...
    func genLine<T:_Field>(_ x:T)-> String {
    ...
    func testOutput() {
        ...
        let hhh = Complex.OperatorSum.Number(ComplexNumber(r: 4.real.f, i: "x".rvar)).f
        let uc = "x".rvar + 1.real.f
        let cu = 1.real.f + "x".rvar
        let auhs = 3.complex(i: 4).f
        let ggg = Complex.OperatorSum.Number(ComplexNumber(r: "a_1".rvar, i: "b_1".rvar)).f
        let hch = Complex.OperatorSum.Number(ComplexNumber(r: "a_2".rvar, i: "b_2".rvar)).f
        let z = Complex.OperatorSum.Number(ComplexNumber(r: x, i: y)).f
